...
const V5P_RUNTIME = 'E:/MyProject/ToLinuxServer/package_v4c_finetune'
const V5P_PYTHON = 'C:/Users/jbbj/AppData/Local/Programs/Python/Python310/python.exe'
const V5P_DIRECT_RUNNER = `${PROJECT_ROOT}/server/scripts/v5p_direct_runner.py`
...
export const V5P_DIRECT_PRESET = {
  ...
  directControlAdapter: `${PROJECT_ROOT}/server/scripts/v5p_direct_control.py`,
